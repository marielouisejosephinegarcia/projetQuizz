...
<body>
    <div class="d-inline-flex d-lg-flex flex-column justify-content-lg-end" style="background-image: url(&quot;assets/img/img-bg.png&quot;);height: 650px;margin: 0px 0px 0px 224px;width: 985px;">
        <div class="text-center d-inline-flex align-items-lg-center" style="background-color: #042425;height: 75px;width: 985px;margin: -1px -7px 282px 1px;"><img src="assets/img/Sans%20titre-1.png" style="width: 147px;height: 152px;margin: 9px 221px 0px 0px;">
            <h1 class="text-center d-lg-flex align-items-lg-center" style="color: rgb(255,255,255);">Le plaisir de jouer</h1>
        </div>
        <div style="background-color: #fefefe;width: 936px;height: 666px;margin: -280px -2px 7px 26px;padding: 0px;">
